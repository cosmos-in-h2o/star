...
namespace star {
    ...
    EventType KeyPressedEvent::getType() { return EventType::KEY_PRESSED; }

    bool KeyPressedEvent::isRepeat() const { return this->_isRepeat; }

    KeyReleasedEvent::KeyReleasedEvent(Key key) : KeyEvent(key) {}

    EventType KeyReleasedEvent::getType() { return EventType::KEY_RELEASED; }

    KeyTypedEvent::KeyTypedEvent(Key key) : KeyEvent(key) {}

    EventType KeyTypedEvent::getType() { return EventType::KEY_TYPED; }
} // namespace star