...
constexpr int32 starKeyConvert(Key star_key) {
    ...
    case Key::SHIFT:
        return GLFW_KEY_LEFT_SHIFT; // Assuming both left and right shift map to
                                    // GLFW_KEY_LEFT_SHIFT
    case Key::CTRL:
        return GLFW_KEY_LEFT_CONTROL; // Assuming both left and right ctrl map
                                      // to GLFW_KEY_LEFT_CONTROL
    case Key::ALT:
        return GLFW_KEY_LEFT_ALT; // Assuming both left and right alt map to
                                  // GLFW_KEY_LEFT_ALT
    case Key::META:
        return GLFW_KEY_LEFT_SUPER; // Assuming both left and right meta map to
                                    // GLFW_KEY_LEFT_SUPER
    case Key::MENU:
